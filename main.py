...
def create_credentials_template():
    ...
    template = """# Hexozenta Free Fire Bot Credentials
    ...
    try:
        ...
        fields = {
            ...
            2: {
                ...
                6: "iG:[C][B][FF0000] @Hexozenta",  # Nickname
                7: 330,                   # Rank
                8: 1000,                  # Field 8
...
def talk_with_ai(question):
    url = f"https://kallu-ai-api.vercel.app/ask?key=KALLU07&message={question}"
    res = requests.get(url)
    if res.status_code == 200:
        data = res.json()
...
    
[FFFF00]ＷＥＬＣＯＭＥ ＴＯ[FF0000] _ _ _ X ³ _ _ _ _   [FFFF00]ＢＯＴ
...
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[9400D3]M A D E B Y [FF0000]HEXOZENTA !!
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFD700] ＦＯＬＬＯＷ    ＭＥ   ＩＮ   [87CEEB]TELEGRAM: [FF0000]@Hexozenta
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
    fields = {
    1: 5,
    2: {
...
async def convert_kyro_to_your_system(target_uid, chat_id, key, iv, nickname="Hexozenta", title_id=None):
...
async def send_kyro_title_adapted(chat_id, key, iv, target_uid, nickname="Hexozenta"):
...
async def send_all_titles_sequentiallly(uid, chat_id, key, iv, region, chat_type):
    ...
    # Send initial message
    start_msg = f"""[B][C][FFFF00] Noobde Black666 ya meku agar tu noob bolra toh tu gay hai
...
"""
    ...
    try:
        ...
        # Completion message
        completion_msg = f"""[B][C][FFFF00]Noobde ab tu bta ye titles aur bol kon noob hai
"""
        await safe_send_message(chat_type, completion_msg, uid, chat_id, key, iv)
...
[FFFFFF]🎯 STATUS: [FFFF00]ACTIVE 24/7
...
[b][i][FFC0CB]youtube: Hexozenta[/b]

[b][c][FFC0CB]subcribe: my_channel[FFFFFF]
 
[b][i][FFA500]telegram: @Hexozenta[/b]

[b][c][FFA500]telegram contact: @Hexozenta[A52A2A]
...
"""
                        ...
                        if inPuTMsG.strip().startswith('/bundle'):
                            ...
                            if len(parts) < 2:
                                ...
                                bundle_list = """[B][C][FFFF00]🎁 AVAILABLE BUNDLES 🎁
...
[FFFFFF]• itachi
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFFF00]Usage: /bundle [name]
[FFFFFF]Example: /bundle midnight-ace
[FF0000]All bundles use ID: 914000002"""
                                ...
                                initial_msg = f"[B][C][FFFF00]🎁 Sending {bundle_name.upper()} bundle...\nID: {bundle_id}\nTarget: {uid}\n"
                                await safe_send_message(response.Data.chat_type, initial_msg, uid, chat_id, key, iv)
                                ...
                                try:
                                    ...
                                    if bundle_packet and online_writer:
                                        ...
                                        success_msg = f"[B][C][FFFF00]✅ BUNDLE SENT SUCCESSFULLY!\n🎁 Name: {bundle_name.upper()}\n🆔 ID: {bundle_id}\n👤 Target: {uid}\n✨ All bundles use the same ID!"
                                        await safe_send_message(response.Data.chat_type, success_msg, uid, chat_id, key, iv)
                                    else:
...
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFFF00]/start       [FFFFFF]Start match
[FFFF00]/exit        [FFFFFF]Leave squad
[FFFF00]/3           [FFFFFF]Send 3-player invite
[FFFF00]/5           [FFFFFF]Send 5-player invite
[FFFF00]/6           [FFFFFF]Send 6-player invite
[FFFF00]! (team code)   [FFFFFF]Join squad
[FFFF00]/ghost (team code)  [FFFFFF]Ghost join squad
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
...
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFFF00]/e [emote]        [FFFFFF]Send emote to yourself
[FFFF00]/e [uid] [emote]  [FFFFFF]Send emote to player
[FFFF00]/e list           [FFFFFF]Show all emotes
[FFFF00]/e list names     [FFFFFF]Show named emotes
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
...
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB][FFFF00]@evos            [FFFFFF]Start evolution cycle
[FFFF00]@sevos           [FFFFFF]Stop evolution cycle
[FFFF00]/evo [num]       [FFFFFF]Send evo emote (1-18)
[FFFF00]/evo [uid] [num] [FFFFFF]Send evo emote to player
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
"""
...
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFFF00]/fast [uid] [emote]    [FFFFFF]Fast emote spam
[FFFF00]/p [uid] [emote] [num] [FFFFFF]Custom emote spam
[FFFF00]/reject [uid]          [FFFFFF]Reject spam
[FFFF00]/reject_stop           [FFFFFF]Stop reject spam
[FFFF00]/msg [text] [times]    [FFFFFF]Message spam
[FFFF00]/stop msg              [FFFFFF]Stop message spam
[FFFF00]/mg [text] [repeats]   [FFFFFF]Wave message spam
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
...
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFFF00]/s1 [uid]  [FFFFFF]Spam with badge 1
[FFFF00]/s2 [uid]  [FFFFFF]Spam with badge 2
[FFFF00]/s3 [uid]  [FFFFFF]Spam with badge 3
[FFFF00]/s4 [uid]  [FFFFFF]Spam with badge 4
[FFFF00]/s5 [uid]  [FFFFFF]Spam with badge 50
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
...
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFFF00]/inv [uid]           [FFFFFF]Send group invite
[FFFF00]/joinroom [id] [pass] [FFFFFF]Join custom room
[FFFF00]/lag [team_code]     [FFFFFF]Lag attack squad
[FFFF00]/stop lag            [FFFFFF]Stop lag attack
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
...
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]─
[FFFF00]/info [uid]       [FFFFFF]Player information
[FFFF00]/status [uid]     [FFFFFF]Check player status
[FFFF00]/gali [name]      [FFFFFF]Gali spam message
[FFFF00]/likes [uid]      [FFFFFF]Send 100 likes
[FFFF00]/ai [question]    [FFFFFF]Chat with AI
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
...
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFFF00]/help        [FFFFFF]Show this help menu
[FFFF00]/admin       [FFFFFF]Admin/contact information
[FFFF00]/quick [code] [emote] [uid] [FFFFFF]Quick emote attack
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
                            ...
                            whitelist_cmnd = """[b][1E90FF]🔐   W H I T E L I S T   C O M M A N D S   🔐
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFFF00]/wllist          [FFFFFF]View whitelisted UIDs
[FFFF00]/wladd (uid)     [FFFFFF]Add UID to whitelist
[FFFF00]/wlremove (uid)  [FFFFFF]Remove UID from whitelist
[FFFF00]/wlenable        [FFFFFF]Enable whitelist-only mode
[FFFF00]/wldisable       [FFFFFF]Disable whitelist-only mode
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""

                            await safe_send_message(response.Data.chat_type, whitelist_cmnd, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            last = """[b][FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[9400D3]M A D E B Y [FF0000]HEXOZENTA !!
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFD700] ＦＯＬＬＯＷ    ＭＥ   ＩＮ   [87CEEB]TELEGRAM: [FF0000]@Hexozenta
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFFF00]💡   T I P: [FFFFFF]Use [FFFF00]/e list names [FFFFFF]to see all named emotes!
[FFFF00]💡   T I P: [FFFFFF]Bot auto-joins squads & rejects requests automatically!
[FFFF00]💡   T I P: [FFFFFF]Use [FFFF00]@evos [FFFFFF]for automatic evolution emote cycle!"""
